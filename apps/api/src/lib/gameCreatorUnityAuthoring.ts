...
function buildGameCreatorAutomationScript(): string {
  return [
    ...
    "        }",
    "",
    "        private static void BuildScenes(GameCreatorPlan plan)",
    "        {",
    ...
    "            encounter.enemyPrefabs = BuildEnemyPrefabArray(plan);",
    "",
    ...
    "        }",
    "",
    "        private static Button CreateMenuButton(Transform parent, string name, string text, int order, UnityEngine.Events.UnityAction onClick)",
    "        {",
    ...
    "        }",
    "",
    "        private static void BuildShellScenes(GameCreatorPlan plan)",
    "        {",
    ...
    "        }",
    "",
    "        private static GameObject[] BuildEnemyPrefabArray(GameCreatorPlan plan)",
    "        {",
    ...
    "        }",
    "",
    "        private static void BuildPrefabs(GameCreatorPlan plan)",
    "        {",
    ...
    "        }",
    "",
    "        private static void WriteValidationReport(GameCreatorPlan plan)",
    "        {",
