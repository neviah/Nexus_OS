    ...
    files.push(
      {
        ...
        content: [
          ...
          "}",
          "",
          `createGame(root, { genre: '${setup.genre}', perspective: '${setup.perspective}' });`,
        ].join("\n"),
      },
      {
        ...
        content: [
          ...
          "};",
          "",
          "export function createGame(root: HTMLElement, config: GameConfig): void {",
          "  root.innerHTML = '';",
          "  const title = document.createElement('h1');",
          "  title.textContent = `Prototype: ${config.genre} (${config.perspective})`;",
          "  const blurb = document.createElement('p');",
          "  blurb.textContent = 'Starter game scaffold generated by NexusOS Game Creator.';",
